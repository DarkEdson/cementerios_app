...
export const AuthProvider = ({children}) => {
  ...
  const deleteUser = (userID, tags, tags2) => {
    ...
    axios
      .get(`${BASE_URL}/user.checkifcandelete/${userID}`, {})
      .then(res => {
        console.log(res.data);
        if (res.data == 'Si se puede borrar') {
          Alert.alert(
            ...
            tags.confirmaEliminarUser
              ? tags.confirmaEliminarUser
              : '¿Esta seguro que \ndesea borrar su usuario?',
            [
              {
                text: tags2.btnsi != '' ? tags2.btnsi : 'Si',
                onPress: async () => {
              ...
              {
                text: tags2.btnno != '' ? tags2.btnno : 'No',
                onPress: () => {},
                style: 'cancel',
              },
            ],
